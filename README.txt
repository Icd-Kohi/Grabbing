...
This is the readme for Grabbing2, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Grabbing) > Ok.
...
- To run the project find Grabbing.java (which will be in under src/main/java/com/grabbing) and right click > Run 'Grabbing'
